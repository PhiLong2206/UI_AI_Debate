...
export const DEBATE_HISTORY_DATA = [
  {
    id: 'ses-001',
    date: '2026-06-15',
    displayDate: '15/06',
    fullDate: '15/06/2026',
    topic: 'Phát triển xe tự hành có nên được ưu tiên hơn giao thông công cộng?',
    type: 'Với AI',
    opponent: 'Đối thủ AI (Trung bình)',
    scores: {
      argumentation: 6.8,
      evidence: 5.8,
      relevance: 7.2,
  ...
  },
  {
    ...
    displayDate: '28/06',
    fullDate: '28/06/2026',
    topic: 'Có nên áp thuế tiêu thụ đặc biệt lên đồ uống có đường để giảm tỷ lệ béo phì?',
    type: 'Với AI',
    opponent: 'Đối thủ AI (Dễ)',
    scores: {
      argumentation: 7.0,
      evidence: 6.2,
      relevance: 7.5,
  ...
  },
  {
    ...
    displayDate: '12/07',
    fullDate: '12/07/2026',
    topic: 'Làm việc từ xa có nên trở thành quyền mặc định của người lao động?',
    type: '1 vs 1',
    opponent: 'Trần Hoàng Nam',
    scores: {
      argumentation: 6.6,
      evidence: 5.9,
      relevance: 7.4,
  ...
  },
  {
    ...
    displayDate: '26/07',
    fullDate: '26/07/2026',
    topic: 'Mạng xã hội có gây hại nhiều hơn mang lại lợi ích cho giới trẻ?',
    type: 'Với AI',
    opponent: 'Đối thủ AI (Trung bình)',
    scores: {
      argumentation: 7.2,
  ...
  },
  {
    ...
    displayDate: '08/08',
    fullDate: '08/08/2026',
    topic: 'Nên cấm sử dụng Trí tuệ nhân tạo trong các bài kiểm tra học thuật?',
    type: 'Với AI',
    opponent: 'Đối thủ AI (Khó)',
    scores: {
      argumentation: 7.0,
      evidence: 6.4,
      relevance: 7.8,
  ...
  },
  {
    ...
    displayDate: '26/08',
    fullDate: '26/08/2026',
    topic: 'Ứng dụng công nghệ chỉnh sửa gen người trong phôi thai có nên được hợp pháp hóa?',
    type: 'Với AI',
    opponent: 'Đối thủ AI (Khó)',
    scores: {
      argumentation: 7.5,
